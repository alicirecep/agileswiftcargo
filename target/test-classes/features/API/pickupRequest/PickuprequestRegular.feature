Feature: As an administrator (admin) I want to be able to access the entire regular pickup list via API connection.
  ...
  Scenario Outline: admin When a GET request with valid authorization is sent to the api/pickuprequest/regular endpoint,
  ...
  Scenario: Invalid Token When a GET request with invalid authorization is sent to the api/pickuprequest/regular endpoint,
